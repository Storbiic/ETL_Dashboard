...
class TestEnhancedPlantItemStatus:
    ...
    def sample_data_with_duplicates(self):
        ...
        return pd.DataFrame({
            "YAZAKI PN": [
                "180AN503913", "180AN503913", "180AN503913",  # Triple duplicate
                "7009-6933", "7009-6933",                      # Double duplicate
            ...
            "Item Description": [
                "Wire Harness A", "Wire Harness A", "Wire Harness A",
                "Connector B", "Connector B", "Terminal C"
            ],
            "Supplier Name": [
                "Global Supplier Inc", "Morocco Automotive MA", "Yazaki Maroc",
                "Standard Supplier", "Morocco Industrial MAROC", "Regular Corp"
            ],
            "FAR Status": [
                "To be Requested", "OK", "Pending",
                "OK", "To be Requested", "OK"
            ]
        })
    ...
    def test_morocco_supplier_prioritization(self, sample_data_with_duplicates, mock_logger):
        ...
        processor.project_columns = ["BX726_BEV_JOB1+90_YMOK", "BX726_BEV_JOB1+90_YRL", "BX726_MCA_JOB1+90_YMOK"]
        ...
        assert any(pattern.lower() in supplier_name.lower() 
    ...
    def test_status_classification_enhanced(self, sample_data_with_duplicates, mock_logger):
        ...
        for raw_status, expected_class in test_cases:
            ...
            assert result == expected_class, f"Status '{raw_status}' should be '{expected_class}', got '{result}'"
    
    def test_plant_item_status_creation_with_duplicates(self, sample_data_with_duplicates, mock_logger):
        ...
        expected_columns = [
            'part_id_std', 'part_id_raw', 'YAZAKI PN', 'project_plant',
            'raw_status', 'status_class', 'is_duplicate', 'is_new', 'notes'
        ]
        for col in expected_columns:
            assert col in result.columns
    
    def test_specific_yazaki_pn_180AN503913(self, sample_data_with_duplicates, mock_logger):
        ...
        resolved = processor._resolve_duplicate_with_morocco_priority('180AN503913', part_records)
    ...
    def test_morocco_pattern_matching(self, mock_logger):
        ...
        resolved = processor._resolve_duplicate_with_morocco_priority('TEST-001', part_records)
