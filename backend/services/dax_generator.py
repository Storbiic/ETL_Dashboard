...
class DAXGenerator:
    ...
    def _determine_category(self, measure_name: str) -> str:
        ...
        elif any(keyword in name_lower for keyword in ['completion', 'project', 'milestone']):
            return 'Project Completion'
        elif any(keyword in name_lower for keyword in ['plant', 'facility']):
            return 'Plant Performance'
        elif any(keyword in name_lower for keyword in ['psw', 'far', 'ppap', 'quality']):
            return 'Quality Metrics'
        elif any(keyword in name_lower for keyword in ['time', 'date', 'trend', 'month']):
    ...
    def _format_dax_file(self, measures: List[Dict[str, str]]) -> str:
        ...
        content.append("// - project_completion_by_plant[project_name] -> status_clean[Project]")
